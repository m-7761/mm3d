...
extern void normalizePath(const char *filename, //REMOVE ME
...
extern std::string normalizePath(const char *filename, const char *pwd = nullptr);
...
extern int mkpath(const char *filename, size_t mode=0755); //OCTAL
